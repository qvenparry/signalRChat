...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function registerEvents(chatHub) {
            ...
            $('#btnSendMsg').click(function () {
                ...
                if (msg == "/fact") {
                    bot_message = "hi all!"
                    var date = GetCurrentDateTime(new Date());
                    chatHub.server.sendMessageToAll('bot', bot_message, date);
                    $("#txtMessage").val('');
                }
            });
        ...
        function AddUser(chatHub, id, name, date) {
            ...
            var Clist = "";
            //var user_exist = '<%= HttpContext.Current.Session["UserExist"] %>';
            if (userId == id) {

                code = $('<div class="box-comment">' +
                    '<img class="img-circle img-sm" src="images/dummy.png" alt="User Image" />' +
                ...
                Clist = $(
                    ...
                    '<a href="#">' +
                    '<img class="contacts-list-img" src="images/dummy.png" alt="User Image" />' +
        ...
        function AddMessage(userName, message, time) {
            ...
            var divChat = '<div class="direct-chat-msg ' + Side + '">' +
                ...
                '</div>' + 
                '<img class="direct-chat-img" src="images/dummy.png" alt="Message User Image">' +
...
<body>
    <form id="form1" runat="server">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>Чат</b></span>
        </a>
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                  <a href="#" class="" >
                      <asp:Button ID="btnSignOut" runat="server" CssClass="btn btn-default btn-flat" Text="Выйти" OnClick="btnSignOut_Click" />
                  </a>
              </li>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="box box-primary direct-chat direct-chat-primary">
                       <div class="box-header with-border">
                            <h3 class="box-title" style="color:dimgrey;">  Добро пожаловать в чат, <span id='spanUser'></span></h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-solid box-primary">
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">В сети <span id='UserCount'></span></h3>
                        </div>
